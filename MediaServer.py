...
parser.add_argument('--bufferquick', '-q', help='taille de bloc de tampon réduite pour un démarrage plus rapide [désactivé par défaut]', action='store_true')
