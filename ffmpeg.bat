...
@set "ffmpeg_vid=%ffmpeg_st% -i !mediabuilder_vid!"
@if "!mediabuilder_aud!" == "" (@set "ffmpeg_aud=-map 0") else (@set "ffmpeg_aud=-thread_queue_size 300000 %ffmpeg_st% -i !mediabuilder_aud! -map 0:v -map 1:a")
)
